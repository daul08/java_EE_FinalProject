    ...
    <div class="row justify-content-center">
        <form action="/postDetail" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="name" <%=readonly%>  value="<%=post.getTitel()%>" class="form-control" id="exampleInputName">
            </div>
            <div class="mb-3">
                <label for="exampleInputName3" class="form-label">Категория:</label>
                <select name="status" id="exampleInputName3" style="width: 100%;" <%=disabled%>>
